var QnAList = [
    ...
    },
    {
        ...
        a:[
            {
                ans : '바쁘다 바빠 나는 나의 길을 간다!',
                type: ['감동란','영양란','동물복지 유정란','화산석 구운란']
            },
            {
                ans : '눈으로만 담고 갈 길을 계속 간다.',
                type: ['구엄닭 방목유정란','NON-GMO 동물복지 유정란','동물복지 유정란','화산석 동물복지 구운유정란']
            },
            {
                ans : '쓰다듬고 간식도 챙겨주고 간다.',
                type: ['구엄닭 방목유정란','NON-GMO 동물복지 유정란','동물복지 유정란','화산석 동물복지 구운유정란']
            }
        ]
    },
    {
        q:"일정을 마치고 집으로 돌아가는 길,<br>계란이 똑 떨어진 게 생각났다!<br>계란 고를 때 당신의 선택은?",
        a:[
            {
                ans : '무조건 저렴한걸로!',
                type: ['영양란','화산석 구운란']
            ...
            {
                ans : '비싸더라도 유정란이 더 맛있고 좋지!',
                type: ['NON-GMO 동물복지 유정란','동물복지 유정란','화산석 동물복지 구운유정란']
            },
            {
                ans : '토종닭이 낳은 계란이 제일 좋지 않겠어?',
                type: ['구엄닭 방목유정란']
            }
        ]
    },
    {
        q:"계란을 낳는 닭도 중요하다는<br>점원의 말에 당신의 생각은?",
        a:[
            {
    ...
    },
    {
        ...
        a:[
            {
                ans : '사료도 중요할 거 같은데 잘 모르겠어',
                type: ['영양란','화산석 구운란','감동란']
            },
            {
                ans : '이왕이면 닭도 좋은 사료 먹는 게 좋지',
                type: ['동물복지 유정란','화산석 동물복지 구운유정란']
            },
            {
                ans : '당연히 좋은 거 먹인 닭이 낳은 계란이지~',
    ...
    },
    {
        ...
        a:[
            {
                ans : '오늘 에너지 소진! 설거지 할 힘도 없다.',
                type: ['화산석 동물복지 구운유정란','화산석 구운란','감동란']
            },
            {
                ans : '피곤하지만 간단하게라도 먹어야지.',
                type: ['영양란']
            },
            {
                ans : '고생한 날 위해 진수성찬으로 먹는다.',
                type: ['구엄닭 방목유정란','NON-GMO 동물복지 유정란','동물복지 유정란']
            }
        ]
    },
    {
        ...
        a:[
            {
                ans : '오늘의 할인은~? 선착순 특가 상품 확인.',
                type: ['영양란','화산석 구운란']
            },
            {
                ans : '제주에 없던 신상품은 뭐가 있을까?',
                type: ['감동란']
            },
            {
                ans : '퀄리티 좋아보이는 상품부터 손이 가~',
                type: ['구엄닭 방목유정란','NON-GMO 동물복지 유정란','동물복지 유정란','화산석 동물복지 구운유정란']
            }
        ]
    }
