var QnAList = [
    ...
    {
        q:"일정을 위해 집을 나선 당신 눈앞에 나타난 귀여운 강아지! 이럴때 당신은?",
        a:[
            {
    ...
    {
        q:"일정을 마치고 집으로 돌아가는 길, 냉장고에 계란이 똑 떨어진 게 생각났다! 계란 고를 때 당신의 선택은?",
        a:[
            {
                ans : '무조건 저렴한걸로!',
                type: ['영양란','화산석 구운란']
    ...
    {
        q:"하루를 마무리하고 침대에 누운 당신, 장을 보기 위해 자연스레 켠 애월아빠들 앱에서 가장 중요하게 보는 것은?",
        a:[
            {
